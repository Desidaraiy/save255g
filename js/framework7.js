...
(function () {
    ...
    window.Framework7 = function (params) {
        ...
        ************   Modals   ************
        ...
        app.prompta = function (text, title, txt, callbackOk, callbackCancel) {
            if (typeof title === 'function') {
                callbackCancel = arguments[2];
                callbackOk = arguments[1];
                title = undefined;
            ...
            return app.modal({
                text: text || '',
                title: typeof title === 'undefined' ? app.params.modalTitle : title,
                afterText: '<div class="input-field"><textarea class="modal-text-input">'+txt+'</textarea></div>',
                buttons: [
                    {
                        text: app.params.modalButtonCancel
                    },
          ...
          var Messages = function (container, params) {
            var defaults = {
                ...
                messageTemplate:
                    ...
                    '{{/if}}' +
                    '<div class="message message-live message-{{type}} {{#if hasImage}}message-pic{{/if}} {{#if avatar}}message-with-avatar{{/if}} {{#if position}}message-appear-from-{{position}}{{/if}}">' +
                        '<div id="containerss" onclick="sendpushik(\'{{text}}\', \'{{name}}\')">' +
